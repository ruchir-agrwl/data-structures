...
# improvise Problem #5 for optimising space complexity
...
advStack.push(12)
advStack.push(2)
print("Min Element Checkpoint #1 ->", advStack.get_minimum())
advStack.pop()
advStack.push(100)
print("Min Element Checkpoint #2 ->", advStack.get_minimum())
